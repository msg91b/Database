...
public class Interface extends javax.swing.JFrame {
    ...
    */
    ...
    jButton12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/User_16x.png"))); // NOI18N
    ...
    jButton15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VSO_Refresh_16x.png"))); // NOI18N
    ...
    jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Cancel_16x.png"))); // NOI18N
    ...
    jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Checkmark_green_12x_16x.png"))); // NOI18N
    ...
    jButton16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VSO_AddUser_16x.png"))); // NOI18N
    ...
    jButton17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VSO_Refresh_16x.png"))); // NOI18N
    ...
    jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Add_16x.png"))); // NOI18N
    ...
    jButton11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Remove_color_16x.png"))); // NOI18N
    ...
    jButton18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/User_16x.png"))); // NOI18N
    ...
    jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ListView_16x.png"))); // NOI18N
    ...
    jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VSO_AddUser_16x.png"))); // NOI18N
    ...
    jButton19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserDefinedTableType_16x.png"))); // NOI18N
    jButton19.setText("Edit Customer");
    ...
    jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Cancel_16x.png"))); // NOI18N
    ...
    jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/User_16x.png"))); // NOI18N
    ...
    jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Add_16x.png"))); // NOI18N
    ...
    jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Remove_color_16x.png"))); // NOI18N
    ...
    private void jTable6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable6MouseClicked
        ...
        if(evt.getClickCount() == 1){
            int selrow = jTable6.getSelectedRow();
            jTable6.setModel(connect.getAllOrdersData());
            jTable6.changeSelection(selrow, 0, false, false);
        }
    ...
    private void jTextField7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField7KeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            jLabel16.setText("");
            jLabel25.setText("");
            if(jTextField7.getText().compareTo("") == 0 || jTextField9.getText().compareTo("") == 0){
                if(jTextField7.getText().compareTo("") == 0){
                    jLabel16.setText("Must not be empty");
                    jLabel16.setForeground(Color.red);
                }
        
                if(jTextField9.getText().compareTo("") == 0){
                    jLabel25.setText("Must not be empty");
                    jLabel25.setForeground(Color.red);
                }
            }
        else{
            String f1 = jTextField7.getText();
            String f2 = jTextField9.getText();
            if(Integer.parseInt(f1) <= 50 && Integer.parseInt(f1) > 0){
                jLabel16.setText("");
    ...
    private void jTable4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable4MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            quantity = Integer.parseInt(model.getValueAt(jTable4.getSelectedRow(),1).toString());
            price = Float.parseFloat(model.getValueAt(jTable4.getSelectedRow(),2).toString());
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            if(Integer.parseInt(jTextField3.getText()) < 50){
                ...
                for(int i = 0; i < model.getRowCount(); i++){
                    if(model.getValueAt(i,0).toString().compareTo(Title) == 0){
                        System.out.println("Check");
                        int currentValue = Integer.parseInt(model.getValueAt(i, 1).toString());
                        int valueToAdd = Integer.parseInt(jTextField3.getText());
                        if(currentValue + valueToAdd <= 50){
                            ...
                            check = true;
                            jLabel7.setText("Total quantity must be < 50");
        ...
        if(jTextField7.getText().compareTo("") == 0 || jTextField9.getText().compareTo("") == 0){
            ...
            if(Integer.parseInt(f1) <= 50 && Integer.parseInt(f1) > 0){
                    ...
                    for(int i = 0; i < jTable1.getRowCount(); i++){
                        int current = Integer.parseInt(jTable1.getValueAt(i, 1).toString());
                        int toAdd = Integer.parseInt(f1);
                        if(jTable1.getValueAt(i, 0).toString().compareTo(jTextField9.getText()) == 0){
                            jTable1.setValueAt(current + toAdd, i, 1);
                            check = true;
                        }
                    }
                    if(!check){
                ...
                if(Integer.parseInt(f1) > 50){
                    jLabel16.setText("Quantity must be < 50");
                    jLabel16.setForeground(Color.red);
                }
                else if(Integer.parseInt(f1) == 0){
                    jLabel16.setText("Quantity must be > 0");
                    jLabel16.setForeground(Color.red);
                }
            }
        }
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        if(Integer.parseInt(jTextField3.getText()) < 50){
            ...
            for(int i = 0; i < jTable4.getRowCount(); i++){
                quantity = Integer.parseInt(jTable4.getValueAt(i,1).toString());
                price = Float.parseFloat(jTable4.getValueAt(i,2).toString());
                total += quantity * price;
            }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
            ...
            float price;
            float total = Float.parseFloat(jTextField4.getText());
            quantity = Integer.parseInt(jTable4.getValueAt(jTable4.getSelectedRow(),1).toString());
            price = Float.parseFloat(jTable4.getValueAt(jTable4.getSelectedRow(), 2).toString());
            total -= quantity * price;
            jTextField4.setText("" + total);
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        ...
        if(jTable1.getRowCount() > 0){
            ...
            jLabel1.setText("There needs to be at least 1 item.");
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        int selected;
        selected = Integer.parseInt(""+jTable3.getSelectedRow());
        String id = jTable3.getValueAt(selected, 0).toString();
        new editCustomer(id).setVisible(true);
